...
| synthetic | php-8.5.2 | 8.5.2 | git_tags | 8.5.1 | 1 | `major_token_index=1` |
...
- `libpng-1.6.54` (current `1.6.54`, constrained by `min_version=1.6.52`):
  - `1.6.53, 1.6.52`
...
- `libtiff-4.3.0` (current `4.3.0`, constrained by `min_version=4.1.0`):
  - `4.2.0, 4.1.0`
- `libtiff-4.7.1` (current `4.7.1`, constrained by `min_version=4.7.0`, `major_token_index=1`):
  - `4.7.0`
...
- `libxml2-2.15.1` (current `2.15.1`, constrained by `min_version=2.14.6`):
  - `2.15.0, 2.14.6`
...
- `openssl-3.6.1` (current `3.6.1`, constrained by `min_version=3.6.0`, `major_token_index=1`):
  - `3.6.0`
...
- `php-8.5.2` (current `8.5.2`, constrained by `major_token_index=1`):
  - `8.5.1`
- `poppler-21.07.0` (current `21.07.0`):
  - `21.06.1, 21.06.0, 21.05.0, 21.04.0, 21.03.0, 21.02.0, 21.01.0`
- `poppler-26.02.0` (current `26.02.0`):
  - `26.01.0`
- `sqlite3-3.37.0-I` (current `3.37.0`, manual):
  - `3.36.0`
- `sqlite3-3.37.0-II` (current `3.37.0`, manual):
  - `3.36.0`
...
- `sudo-1.9.16` (current `1.9.16`, constrained by `min_version=1.9.1`, excluding `1.9.4`):
...
- `sudo-1.9.16p2` (current `1.9.16p2`, constrained by `min_version=1.9.1`, excluding `1.9.4`):
